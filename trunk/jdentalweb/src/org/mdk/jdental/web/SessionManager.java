...
public class SessionManager {
	...
	public void createSession(String sessionUser, int type){
		...
		//create
		Properties prop = ManageProperties.getInstance().setPropFile(sessionName, utility.getCurrentDateTimeFormated("dd/MMM/yyyy HH:mm:ss"), type);
		try {
