...
import org.mdk.jdental.dataobjects.LogData;
...
public class LoggerManager {
		...
		private void log(String className, String logLine, boolean logLevel) {
			String formatedLog = " ("+className+") "+logLine;
				...
				fileName = Constants.APP_FOLDER + fileName;
				
				GenericUtilities su = new GenericUtilities();
				
				String stime = su.getCurrentDateTimeFormated("yyyyMMMdd_HH:mm:ss");
				if(logLevel){
